...
daw_settings = {
    ...
    'SYNTH_PLUGIN_PATH_WINDOWS': f"C:{os.sep}Program Files (x86){os.sep}Steinberg{os.sep}TAL-U-NO-LX-V2.vst3{os.sep}Contents{os.sep}x86_64-win{os.sep}TAL-U-NO-LX-V2.vst3",
    'SYNTH_NAME': "TAL-Uno",
...
fixed_parameters = {
    ...
    "midi learn":0.0,
    "master octave transpose":0.5,
    "master fine tune": 0.5,
}
...
dawdreamer_param_name_to_xml_key_mapping = {
    'modulation': 'modulation',
    'dco lfo value': 'dcolfovalue',
    'dco pwm value': 'dcopwmvalue',
    'dco pwm mode': 'dcopwmmode',
    'dco pulse enabled': 'dcopulseenabled',
    'dco saw enabled': 'dcosawenabled',
    'dco sub osc enabled': 'dcosuboscenabled',
    'dco sub osc volume': 'dcosuboscvolume',
    'dco noise volume': 'dconoisevolume',
    'dco hp filter': 'hpfvalue',
    'filter cutoff': 'filtercutoff',
    'filter resonance': 'filterresonance',
    'filter env mode': 'filterenvelopemode',
    'filter env': 'filterenvelopevalue',
    'filter modulation': 'filtermodulationvalue',
    'filter keyboard': 'filterkeyboardvalue',
    'master volume': 'volume',
    'master fine tune': 'masterfinetune',
    'master octave transpose': 'octavetranspose',
    'vca mode': 'vcamode',
    'attack': 'adsrattack',
    'decay': 'adsrdecay',
    'sustain': 'adsrsustain',
    'release': 'adsrrelease',
    'lfo rate': 'lforate',
    'lfo delay': 'lfodelaytime',
    'lfo trigger mode': 'lfotriggermode',
    'lfo trigger enabled': 'lfomanualtriggerenabled',
    'lfo trigger active': 'lfomanualtriggeractive',
    'lfo waveform': 'lfowaveform',
    'chorus 1': 'chorus1enable',
    'chorus 2': 'chorus2enable',
    'arp enabled': 'arpenabled',
    'arp sync enabled': 'arpsyncenabled',
    'arp mode': 'arpmode',
    'arp range': 'arprange',
    'arp rate': 'arprate',
    'arp locked': 'arpnotloadsettings',
    'control velocity volume': 'controlvelocityvolume',
    'control velocity envelope': 'controlvelocityenvelope',
    'control pitch bend filter': 'controlbenderfilter',
    'control pitch bend dco': 'controlbenderdco',
    'portamento mode': 'portamentomode',
    'portamento intensity': 'portamentointensity',
    'midi learn': 'midilearn',
    'panic': 'panic',
    'voice hold': 'voicehold',
    'trigger arp by midi channel 16': 'miditriggerarp16sync',
    'clock sync': 'midiclocksync',
    'host sync': 'hostsync',
    'max voices': 'maxpoly',
    'keytranspose': 'keytranspose',
    'special mode': 'arpspecialmode',
    'lfo inverted': 'lfoinverted',
    'portamento poly': 'portamentopoly',
    'sound engine off': 'engineoff',
    'pitch wheel': 'pitchwheel',
    'modulation wheel': 'modulationwheel',
    'midi clear': 'midiclear',
    'midi lock': 'midilock',
    'MPE enabled': 'mpeEnabled',
    'portamento time': 'portamentotimeenabled',
    'FX Reverb Dry / Wet': 'reverbDryWet',
    'FX Reverb Size': 'reverbSize',
    'FX Reverb Delay': 'reverbDelay',
    'FX Reverb Tone': 'reverbTone',
    'FX Delay Dry / Wet': 'delayDryWet',
    'FX Delay Time': 'delayTime',
    'FX Delay Sync': 'delaySync',
    'FX Delay Spread': 'delaySpread',
    'FX Delay Tone': 'delayTone',
    'FX Delay Feedback': 'delayFeedback',
    'MTS Microtuning Active': 'mtsEnabled',
    'Unisono Voices': 'unisonovoices',
    'Unisono Detune': 'unisonodetune',
    'Unisono Spread': 'unsionospread',
